...
<head>
    ...
    <link rel="apple-touch-icon" href="{{('fontend/img/apple-icon.png')}}">
    ...
    <link href="{{('fontend/css/fontawesome-all.min.css')}}" rel="stylesheet">
    <link href="{{('fontend/css/aos.min.css')}}" rel="stylesheet">
    <link href="{{('fontend/css/swiper.css')}}" rel="stylesheet">
    ...
    <!-- Favicon -->
    <link rel="icon" href="{{('fontend/images/favicon.png')}}">
</head>
...
<body>
    ...
    <section class="container py-5">
        ...
        <div class="row">
            <div class="col-12 col-md-4 p-5 mt-3">
                <a href="#"><img src="{{('fontend/images/category_img_01.jpg')}}" class="rounded-circle img-fluid border"></a>
                <h5 class="text-center mt-3 mb-3">Watches</h5>
                <p class="text-center"><a class="btn btn-success">Go Shop</a></p>
            </div>
            <div class="col-12 col-md-4 p-5 mt-3">
                <a href="#"><img src="{{('fontend/images/category_img_02.jpg')}}" class="rounded-circle img-fluid border"></a>
                <h2 class="h5 text-center mt-3 mb-3">Shoes</h2>
                <p class="text-center"><a class="btn btn-success">Go Shop</a></p>
            </div>
            <div class="col-12 col-md-4 p-5 mt-3">
                <a href="#"><img src="{{('fontend/images/category_img_03.jpg')}}" class="rounded-circle img-fluid border"></a>
        ...
        <div class="container py-5">
            ...
            <div class="row">
                <div class="col-12 col-md-4 mb-4">
                    <div class="card h-100">
                        <a href="shop-single.html">
                            <img src="{{('fontend/images/feature_prod_01.jpg')}}" class="card-img-top" alt="...">
                        </a>
                        <div class="card-body">
                ...
                <div class="col-12 col-md-4 mb-4">
                    <div class="card h-100">
                        <a href="shop-single.html">
                            <img src="{{('fontend/images/feature_prod_02.jpg')}}" class="card-img-top" alt="...">
                        </a>
                        <div class="card-body">
                            <ul class="list-unstyled d-flex justify-content-between">
                                <li>
                ...
                <div class="col-12 col-md-4 mb-4">
                    <div class="card h-100">
                        <a href="shop-single.html">
                            <img src="{{('fontend/images/feature_prod_03.jpg')}}" class="card-img-top" alt="...">
                        </a>
                        <div class="card-body">
                            <ul class="list-unstyled d-flex justify-content-between">
                                <li>
    ...
    <script src="{{('fontend/bootstrap.min.js')}}"></script><!-- Bootstrap framework -->
    <script src="{{('fontend/js/purecounter.min.js')}}"></script> <!-- Purecounter counter for statistics numbers -->
    <script src="{{('fontend/js/swiper.min.js')}}"></script><!-- Swiper for image and text sliders -->
    <script src="{{('fontend/js/aos.js')}}"></script><!-- AOS on Animation Scroll -->
    <script src="{{('fontend/js/script.js')}}"></script>  <!-- Custom scripts -->
    <!-- End Script -->
</body>
