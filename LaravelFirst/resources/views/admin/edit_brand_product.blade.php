...
<div class="container">
  ...
  <div class="form-group">
    ...
    <div class="form-group">
      ...
      <textarea class="form-control" rows="5"name="brand_product_desc">{{$edit_value->brand_desc}}</textarea>
    </div>
    ...
    <button type="submit" name="update_brand_product" class="btn btn-primary">Submit</button>
    <?php
